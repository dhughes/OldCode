<%@ Control Language="c#" AutoEventWireup="false" Codebehind="exception.ascx.cs" Inherits="ModelGlueApplicationTemplate.views.exception" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<h3>Oops!</h3>
<table>
	<tr>
